...
So we'll document this for you, in a standard set of ops manuals.<FootnoteRef number="3" ref="ops-manuals" /> For example, where to save receipts so you can file your quarterly returns. And you'll create and share your own: how to turn off the salon's alarm system; how to set up your market stall.
