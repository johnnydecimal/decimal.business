...
Love them or not,<FootnoteRef number="3" ref="maccas" /> McDonald's is undeniably successful. Famously, they're all the same, no matter where in the world you are.
...
So we'll document this for you, in a standard set of ops manuals.<FootnoteRef number="4" ref="ops-manuals" /> And you'll create and share your own: how to turn off the salon's alarm system; how (and how often) to clean the coffee machine; where to save receipts so you can file your quarterly returns.
